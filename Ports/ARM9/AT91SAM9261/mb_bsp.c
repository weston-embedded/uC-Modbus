...
*********************************************************************************************************
*/
#define  AT91SAM9261_USART0_BASE_ADDR    ((CPU_INT32U)0xFFFB0000)
#define  AT91SAM9261_USART1_BASE_ADDR    ((CPU_INT32U)0xFFFB4000)
#define  AT91SAM9261_USART2_BASE_ADDR    ((CPU_INT32U)0xFFFB8000)
#define  AT91SAM9261_DBGU_BASE_ADDR      ((CPU_INT32U)0xFFFFF200)
#define  AT91SAM9261_AIC_BASE_ADDR       ((CPU_INT32U)0xFFFFF000)
#define  AT91SAM9261_PIOA_BASE_ADDR      ((CPU_INT32U)0xFFFFF400)
#define  AT91SAM9261_PIOC_BASE_ADDR      ((CPU_INT32U)0xFFFFF600)
#define  AT91SAM9261_PMC_BASE_ADDR       ((CPU_INT32U)0xFFFFFC00)
#define  AT91SAM9261_TC0_BASE_ADDR       ((CPU_INT32U)0xFFFA0000)
#define  AT91SAM9261_TC1_BASE_ADDR       ((CPU_INT32U)0xFFFA0040)
#define  AT91SAM9261_TC2_BASE_ADDR       ((CPU_INT32U)0xFFFA0080)
                                                                /* -------------------- Peripheral IDs -------------------- */
#define  AT91SAM9261_PER_ID_SYS                      1
#define  AT91SAM9261_PER_ID_PIOA                     2
#define  AT91SAM9261_PER_ID_PIOB                     3
#define  AT91SAM9261_PER_ID_PIOC                     4

#define  AT91SAM9261_PER_ID_USART0                   6
#define  AT91SAM9261_PER_ID_USART1                   7
#define  AT91SAM9261_PER_ID_USART2                   8
#define  AT91SAM9261_PER_ID_TC0                     17
#define  AT91SAM9261_PER_ID_TC1                     18
#define  AT91SAM9261_PER_ID_TC2                     19

/*
*********************************************************************************************************
*                                            AT91SAM9261 REGISTER BIT DEFINES
*********************************************************************************************************
*/
                                                                /* --------- USART MODE (US_MR) REGISTER BIT DEFINES ------- */
#define  AT91SAM9261_USART_MR_MODE_NORMAL      (0x00 <<  0)      
#define  AT91SAM9261_USART_MR_MODE_RS485       (0x01 <<  0)
#define  AT91SAM9261_USART_MR_MODE_IRDA        (0x08 <<  0)

#define  AT91SAM9261_USART_MR_USCLKS_MCK       (0x00 <<  4)
#define  AT91SAM9261_USART_MR_USCLKS_MCK_DIV   (0x01 <<  4)
#define  AT91SAM9261_USART_MR_USCLKS_SCK       (0x03 <<  4)

#define  AT91SAM9261_USART_MR_CHRL_5           (0x00 <<  6)
#define  AT91SAM9261_USART_MR_CHRL_6           (0x01 <<  6)
#define  AT91SAM9261_USART_MR_CHRL_7           (0x02 <<  6)
#define  AT91SAM9261_USART_MR_CHRL_8           (0x03 <<  6)

#define  AT91SAM9261_USART_MR_PAR_EVEN         (0x00 <<  9)
#define  AT91SAM9261_USART_MR_PAR_ODD          (0x01 <<  9)
#define  AT91SAM9261_USART_MR_PAR_FORCED0      (0x02 <<  9)
#define  AT91SAM9261_USART_MR_PAR_FORCED1      (0x03 <<  9)
#define  AT91SAM9261_USART_MR_PAR_NONE         (0x04 <<  9)
#define  AT91SAM9261_USART_MR_PAR_MULTIDROP    (0x06 <<  9)
 
#define  AT91SAM9261_USART_MR_NBSTOP_1         (0x00 << 12)
#define  AT91SAM9261_USART_MR_NBSTOP_1_5       (0x01 << 12)
#define  AT91SAM9261_USART_MR_NBSTOP_2         (0x02 << 12)

#define  AT91SAM9261_USART_MR_CHMODE_NORMAL    (0x00 << 14)
#define  AT91SAM9261_USART_MR_CHMODE_AUTOECHO  (0x01 << 14)
#define  AT91SAM9261_USART_MR_CHMODE_LOOPBACK  (0x02 << 14)
#define  AT91SAM9261_USART_MR_CHMODE_REMOTE    (0x03 << 14)
                                                                /* ------ USART CONTROL (US_CR) REGISTER BIT DEFINES ------- */
#define  AT91SAM9261_USART_CR_RSTRX            DEF_BIT_02
#define  AT91SAM9261_USART_CR_RSTTX            DEF_BIT_03
#define  AT91SAM9261_USART_CR_RXEN             DEF_BIT_04
#define  AT91SAM9261_USART_CR_RXDIS            DEF_BIT_05
#define  AT91SAM9261_USART_CR_TXEN             DEF_BIT_06
#define  AT91SAM9261_USART_CR_TXDIS            DEF_BIT_07
#define  AT91SAM9261_USART_CR_RSTSTA           DEF_BIT_08
                                                                /* -- USART CHANNEL STATUS (US_CSR) REGISTER BIT DEFINES --- */
#define  AT91SAM9261_USART_CSR_RXRDY           DEF_BIT_00
#define  AT91SAM9261_USART_CSR_TXRDY           DEF_BIT_01
#define  AT91SAM9261_USART_CSR_ENDRX           DEF_BIT_03
#define  AT91SAM9261_USART_CSR_ENDTX           DEF_BIT_04
#define  AT91SAM9261_USART_CSR_OVRE            DEF_BIT_05
#define  AT91SAM9261_USART_CSR_FRAME           DEF_BIT_06
#define  AT91SAM9261_USART_CSR_PARE            DEF_BIT_07
#define  AT91SAM9261_USART_CSR_TIMEOUT         DEF_BIT_08
#define  AT91SAM9261_USART_CSR_TXEMPTY         DEF_BIT_09
#define  AT91SAM9261_USART_CSR_ITERATION       DEF_BIT_09
#define  AT91SAM9261_USART_CSR_TXBUFE          DEF_BIT_11
#define  AT91SAM9261_USART_CSR_RXBUFF          DEF_BIT_12

#define  AT91SAM9261_USART_IDR_DIS_ALL         0xFFFFFFFF
                                                               /* -------------- TC_CMR Register Bit Defines ------------- */
#define  AT91SAM9261_TC_CMR_CPCTRG_EN          DEF_BIT_14
                                                               /* -------------- TC_IER Register Bit Defines ------------- */
#define  AT91SAM9261_TC_IER_CPCS               DEF_BIT_04
                                                               /* --------------- TC_SR Register Bit Defines ------------- */
#define  AT91SAM9261_TC_SR_CPCS                DEF_BIT_04
                                                               /* --------------- TC_CR Register Bit Defines ------------- */
#define  AT91SAM9261_TC_CCR_CLKEN              DEF_BIT_00
#define  AT91SAM9261_TC_CCR_CLKDIS             DEF_BIT_01
#define  AT91SAM9261_TC_CCR_SWTRG              DEF_BIT_02
...
#define  AT91SAM9261_AIC_SMR_SRCTYPE_HIGH_LEVEL  (0x02 <<  5)
#define  AT91SAM9261_AIC_SMR_PRIOR_LOWEST        (0x00 <<  0)
                                                                /* -------------  GPIOx Register Bit Defines -------------- */
                                                                /* Set GPIOA pins 9 and 10 as DBGU pins                     */
#define  AT91SAM9261_PIOA_PINS_DBGU             DEF_BIT_09 | \
                                                DEF_BIT_10
                                                                /* Set GPIOC pins 8, 9, 10, & 11 as US0 pins                */
#define  AT91SAM9261_PIOC_PINS_USART0           DEF_BIT_08 | \
                                                DEF_BIT_09 | \
                                                DEF_BIT_10 | \
                                                DEF_BIT_11

                                                                /* Set GPIOC pins 12, 13 as US1 pins                        */
#define  AT91SAM9261_PIOC_PINS_USART1          (DEF_BIT_12 | \
                                                DEF_BIT_13)

                                                                /* Set the GPIOA pins 12, 13 as RTS1 and CTS1               */
#define  AT91SAM9261_PIOA_PINS_USART1          (DEF_BIT_12 | \
                                                DEF_BIT_13)

                                                                /* Set GPIOD pins 14, 15 as US2 pins                        */
#define  AT91SAM9261_PIOC_PINS_USART2          (DEF_BIT_14 | \
                                                DEF_BIT_15)
                                                 
                                                                /* Set the GPIOA pins 15, 16 as RTS2 and CTS2               */
#define  AT91SAM9261_PIOA_PINS_USART2          (DEF_BIT_15 | \
                                                DEF_BIT_16)
...
typedef  struct  at91sam9261_usart {                            /* +------------|---------------------|--------------------+ */
    ...
    CPU_INT32U  US_BRGR;                                        /* |0x0020      | Baud Rate Generator |US_BRGR             | */
                                                                ...
                                                                /* |================= PIO REGISTERS =====================  | */
typedef  struct  at91sam9261_pio {                              /* +------------|---------------------|--------------------+ */
    ...
    CPU_INT32U  RESERVED6;                                      /* |0x00AC      | Reserved            |------              | */ 
                                                                ...
                                                                /* |================= AIC REGISTERS =====================  | */
typedef  struct  at91sam9261_aic {                              /* +------------|---------------------|--------------------+ */
    ...
    CPU_INT32U  AIC_FFSR;                                       /* |0x0104      | Fast Forcing Status |AIC_FSR             | */
                                                                ...
                                                                /* |================= PMC REGISTER  =====================  | */
typedef struct at91sam9261_pmc {                                /* +------------|---------------------|--------------------+ */
                      ...
                      CPU_INT08U  stops)
{
              ...
              CPU_INT08U         dev_pio_per_id;               
              CPU_INT32U         dev_pio_val;
              CPU_INT32U         dev_usart_handler;    
    
    volatile  AT91SAM9261_PIO    *p_dev_pio;
    volatile  AT91SAM9261_USART  *p_dev_usart;  
    volatile  AT91SAM9261_AIC    *p_dev_aic;
    volatile  AT91SAM9261_PMC    *p_dev_pmc;
    ...
    if (pch != (MODBUS_CH *)0){
        ...
        switch (parity) {                                             /* (1) Setup USART parity                       */
            case MODBUS_PARITY_ODD:
                 dev_usart_mr = AT91SAM9261_USART_MR_PAR_ODD;
                 break;
            ...
            default:
                 dev_usart_mr = AT91SAM9261_USART_MR_PAR_NONE;
                 break;
        }
        
        if (bits == 7) {                                              /* (2) Setup #bits                               */
            dev_usart_mr |= AT91SAM9261_USART_MR_CHRL_7;
        } else {
            dev_usart_mr |= AT91SAM9261_USART_MR_CHRL_8;
        }
            
        if (stops == 2) {                                             /* (3) Setup # stops bits                        */
            dev_usart_mr |= AT91SAM9261_USART_MR_NBSTOP_2;
        }
        ...
        switch (port_nbr) {                                           /* ----------- USART PORT SELECT --------------- */ 
            default:
            case MB_BSP_UART_00:
                 p_dev_pio         = (AT91SAM9261_PIO   *)(AT91SAM9261_PIOC_BASE_ADDR);
                 p_dev_usart       = (AT91SAM9261_USART *)(AT91SAM9261_USART0_BASE_ADDR);
                 dev_pio_val       = (CPU_INT32U         )(AT91SAM9261_PIOC_PINS_USART0);
                 dev_per_id        = (CPU_INT08U         )(AT91SAM9261_PER_ID_USART0);
                 dev_usart_handler = (CPU_INT32U         )(MB_CommRxTxISR_0_Handler);
                 dev_pio_per_id    = (CPU_INT08U         )(AT91SAM9261_PER_ID_PIOC);
#if (MB_BSP_CFG_UART_00_MODE == MB_BSP_UART_RS485_MODE)
                 usart_mr         |= AT91SAM9261_USART_MR_MODE_RS485;
#endif                 
                 break;
                 
            case MB_BSP_UART_01:
                 p_dev_pio         = (AT91SAM9261_PIO   *)(AT91SAM9261_PIOC_BASE_ADDR);
                 p_dev_usart       = (AT91SAM9261_USART *)(AT91SAM9261_USART1_BASE_ADDR);
                 dev_pio_val       = (CPU_INT32U         )(AT91SAM9261_PIOC_PINS_USART1);
                 dev_per_id        = (CPU_INT08U         )(AT91SAM9261_PER_ID_USART1);
            ...
            case MB_BSP_UART_02:
                 p_dev_pio         = (AT91SAM9261_PIO   *)(AT91SAM9261_PIOC_BASE_ADDR);
                 p_dev_usart       = (AT91SAM9261_USART *)(AT91SAM9261_USART2_BASE_ADDR);
                 dev_pio_val       = (CPU_INT32U         )(AT91SAM9261_PIOC_PINS_USART2);
                 dev_per_id        = (CPU_INT08U         )(AT91SAM9261_PER_ID_USART2);
            ...
            case MB_BSP_UART_DBG:
                 p_dev_pio         = (AT91SAM9261_PIO   *)(AT91SAM9261_PIOA_BASE_ADDR);
                 p_dev_usart       = (AT91SAM9261_USART *)(AT91SAM9261_DBGU_BASE_ADDR);
                 dev_pio_val       = (CPU_INT32U         )(AT91SAM9261_PIOA_PINS_DBGU);
                 dev_per_id        = (CPU_INT08U         )(AT91SAM9261_PER_ID_SYS);
                 dev_pio_per_id    = (CPU_INT08U         )(AT91SAM9261_PER_ID_PIOA);
                 
                 break;
        }

        p_dev_pmc            = (AT91SAM9261_PMC *)(AT91SAM9261_PMC_BASE_ADDR);        
        p_dev_pmc->PMC_PCER  = (CPU_INT32U       )(1 << dev_per_id);
        p_dev_pmc->PMC_PCER  = (CPU_INT32U       )(1 << dev_pio_per_id);
        p_dev_pio->PIO_PDR   = dev_pio_val;
        p_dev_pio->PIO_ASR   = dev_pio_val;

        if ((port_nbr == MB_BSP_UART_01) || 
            (port_nbr == MB_BSP_UART_02)) {       
            p_dev_pmc->PMC_PCER  = (CPU_INT32U    )(1 << AT91SAM9261_PER_ID_PIOA);
            
            if (port_nbr == MB_BSP_UART_01) {
               p_dev_pio->PIO_PDR = AT91SAM9261_PIOA_PINS_USART1;
               p_dev_pio->PIO_BSR = AT91SAM9261_PIOA_PINS_USART1;  
            } else {
               p_dev_pio->PIO_PDR = AT91SAM9261_PIOA_PINS_USART2;
               p_dev_pio->PIO_BSR = AT91SAM9261_PIOA_PINS_USART2;              
            }
            
        }
        
        p_dev_usart->US_IDR  = AT91SAM9261_USART_IDR_DIS_ALL;

        p_dev_usart->US_CR   = AT91SAM9261_USART_CR_RSTSTA      /* Reset status bits, Tx and Rx                              */
                             | AT91SAM9261_USART_CR_RSTRX
                             | AT91SAM9261_USART_CR_RSTTX;

        p_dev_usart->US_CR   = AT91SAM9261_USART_CR_RXEN        /* Enable receiver and tranmitter                            */
                             | AT91SAM9261_USART_CR_TXEN;
        
        p_dev_usart->US_IER  = AT91SAM9261_USART_CSR_RXRDY;     /* Enable Rx interrupts                                      */
        ...
        if (port_nbr != MB_BSP_UART_DBG) {
            p_dev_aic                      = (AT91SAM9261_AIC *)(AT91SAM9261_AIC_BASE_ADDR);
            p_dev_aic->AIC_SVR[dev_per_id] = dev_usart_handler;
            p_dev_aic->AIC_SMR[dev_per_id] = AT91SAM9261_AIC_SMR_SRCTYPE_HIGH_LEVEL
                                           | AT91SAM9261_AIC_SMR_PRIOR_LOWEST;
...
void  MB_CommRxIntDis (MODBUS_CH  *pch)
{
    ...
    p_dev_usart->US_IDR = AT91SAM9261_USART_CSR_RXRDY;
}
...
{   
    ...
    p_dev_usart->US_IER = AT91SAM9261_USART_CSR_RXRDY;
}
...
*
* Note(s)     : The pseudo-code for this function should be:  
*
...
void  MB_CommRxTxISR_Handler (CPU_INT08U  port_nbr)
{
    ...
    if ((DEF_BIT_IS_SET(p_dev_usart->US_IMR, AT91SAM9261_USART_CSR_RXRDY)) && \
        (DEF_BIT_IS_SET(p_dev_usart->US_CSR, AT91SAM9261_USART_CSR_RXRDY))) {
    ...
    if ((DEF_BIT_IS_SET(p_dev_usart->US_IMR, AT91SAM9261_USART_CSR_TXRDY)) && \
        (DEF_BIT_IS_SET(p_dev_usart->US_CSR, AT91SAM9261_USART_CSR_TXRDY))) {
    
        pch->TxCtr++;
        MB_TxByte(pch);                                         /* Send next byte                                            */
    }
    
    if ((DEF_BIT_IS_SET(p_dev_usart->US_IMR, AT91SAM9261_USART_CSR_OVRE))) {   
        p_dev_usart->US_CR = AT91SAM9261_USART_CR_RSTSTA;      /* if an overrun occurs, reset the status bits                */
    }
}
...
void  MB_CommTxIntDis (MODBUS_CH  *pch)
{
    ...
    p_dev_usart->US_IDR = AT91SAM9261_USART_CSR_TXRDY;
}
...
void  MB_CommTxIntEn (MODBUS_CH  *pch)
{
    ...
    p_dev_usart->US_IER = AT91SAM9261_USART_CSR_TXRDY;
}
...
void  MB_RTU_TmrInit (void)
{
              CPU_INT32U       dev_mclk_freq;
              CPU_INT08U       dev_per_id;
    volatile  AT91SAM9261_TC   *p_dev_tc;
    volatile  AT91SAM9261_PMC  *p_dev_pmc;
    volatile  AT91SAM9261_AIC  *p_dev_aic;
    ...
    p_dev_tc    = (AT91SAM9261_TC *)(AT91SAM9261_TC0_BASE_ADDR);    
    dev_per_id  = (CPU_INT08U      )(AT91SAM9261_PER_ID_TC0);
 

#elif (MS_BSP_CFG_TMR == MB_BSP_TMR_1)    
    p_dev_tc    = (AT91SAM9261_TC *)(AT91SAM9261_TC1_BASE_ADDR);
    dev_per_id  = (CPU_INT08U      )(AT91SAM9261_PER_ID_TC1);

#else
    p_dev_tc    = (AT91SAM9261_TC *)(AT91SAM9261_TC2_BASE_ADDR);
    dev_per_id  = (CPU_INT08U      )(AT91SAM9261_PER_ID_TC2);    
#endif
    p_dev_pmc->PMC_PCER  = (1 << dev_per_id);   
    
    p_dev_tc->TC_CCR     = AT91SAM9261_TC_CCR_CLKDIS;           /* TCx Clk disable                                           */
    p_dev_tc->TC_CMR     = AT91SAM9261_TC_CMR_CPCTRG_EN;        /* TCx Compare trigger enable                                */
    p_dev_tc->TC_RC      = MB_Tmr_ReloadCnts;                   /* TCx RC compare trigger value                              */

    p_dev_tc->TC_CCR     = AT91SAM9261_TC_CCR_CLKEN;            /* TCx clk enable                                            */            
    p_dev_tc->TC_CCR     = AT91SAM9261_TC_CCR_SWTRG;            /* TCx Software trigger                                      */ 
    
    p_dev_tc->TC_IER     = AT91SAM9261_TC_IER_CPCS;             /* TCx Software trigger                                      */ 
    
                                                                /* AIC configuration                                         */
    p_dev_aic->AIC_SVR[dev_per_id] = (CPU_INT32U)MB_RTU_TmrISR_Handler;  
    p_dev_aic->AIC_SMR[dev_per_id] = AT91SAM9261_AIC_SMR_SRCTYPE_HIGH_LEVEL 
                                   | AT91SAM9261_AIC_SMR_PRIOR_LOWEST;
    p_dev_aic->AIC_ICCR            = (CPU_INT32U)(1 << dev_per_id);
    p_dev_aic->AIC_IECR            = (CPU_INT32U)(1 << dev_per_id);
...
void  MB_RTU_TmrExit (void)
{
    ...
    p_dev_tc->TC_CCR = AT91SAM9261_TC_CCR_CLKDIS;    
}
#endif
...
void  MB_RTU_TmrISR_Handler (void)
{
    ...
    if (DEF_BIT_IS_SET(p_dev_tc->TC_SR , AT91SAM9261_TC_SR_CPCS)) {
